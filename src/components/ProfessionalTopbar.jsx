        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-4 min-h-[72px]">
          ...
          <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
            ...
            <button
              ...
              className="md:hidden p-2 -ml-2 rounded-md hover:bg-slate-100 transition-colors flex-shrink-0"
            ...
            <div className="flex items-center gap-3">
              ...
              {title === 'Calculator' && (
                <span className="hidden lg:inline-block px-2 py-0.5 bg-slate-100 text-slate-600 text-xs font-medium rounded">
                  Core Product
                </span>
              )}
            </div>
