    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Last Updated: January 11, 2026</p>
        </div>
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">1.1 Information You Provide</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">1.2 Information Collected Automatically</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">1.3 Information from Third Parties</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.1 Supabase (Authentication & Database)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.2 Anthropic (AI Analysis)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://www.anthropic.com/legal/privacy</a></li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.3 Stripe (Payment Processing)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://stripe.com/privacy</a></li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.4 Gumroad (Alternative Payment Processing)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://gumroad.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://gumroad.com/privacy</a></li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.5 Upstash Redis (Rate Limiting)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://upstash.com/docs/redis/overall/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://upstash.com/docs/redis/overall/privacy</a></li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.6 Resend (Transactional Emails)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <li><strong>Privacy Policy:</strong> <a href="https://resend.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://resend.com/legal/privacy-policy</a></li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.7 Vercel (Hosting)</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">4. How We Protect Your Information</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.1 Access Your Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
              You can access your account information and portfolio data at any time by logging into your account.
            </p>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.2 Export Your Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.3 Delete Your Data</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.4 Opt-Out of Communications</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.5 GDPR Rights (EU Users)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.6 CCPA Rights (California Users)</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section>
            ...
            <ul className="list-none space-y-2 text-slate-700 mb-4">
              <li><strong>Email:</strong> <a href="mailto:hello@rebalancekit.com" className="text-blue-600 hover:underline">hello@rebalancekit.com</a></li>
          ...
          <section className="bg-slate-50 border border-slate-200 rounded-lg p-6 mt-8">
            <h3 className="text-lg font-bold text-slate-900 mb-3">Privacy Summary</h3>
