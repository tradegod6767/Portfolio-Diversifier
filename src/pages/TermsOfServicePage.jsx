    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-slate-200 p-8 md:p-12">
        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Financial Disclaimer & No Investment Advice</h2>
            <p className="text-slate-700 leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Account and Subscription</h2>

            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">Free Tier</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">Pro Subscription</h3>
            <p className="text-slate-700 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">Billing and Refunds</h3>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed mb-4">
              Your use of the Service is governed by our <Link to="/privacy" className="text-blue-600 hover:underline">Privacy Policy</Link>. By using the Service, you consent to:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
          ...
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              <strong>Email:</strong> <a href="mailto:hello@rebalancekit.com" className="text-blue-600 hover:underline">hello@rebalancekit.com</a>
            </p>
          </section>
